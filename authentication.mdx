...
description: "To get started using the Revocalize API, you'll need to generate an API Key through your Revocalize dashboard: [www.revocalize.ai/settings/api-keys](https://www.revocalize.ai/settings/api-keys)."
---
